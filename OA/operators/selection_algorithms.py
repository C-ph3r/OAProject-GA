...
def SUS_selection(pop, pop_fit, num_selections):
    """
    ...
    Outputs: list - List of selected individuals
    """
    ...
    for pointer in sorted(pointers):
        ...
        selected.append(pop[index - 1])
    
    return selected

def boltzmann_selection(pop, pop_fit, temperature):
    """
    ...
    for _ in range(len(pop)):
        selected.append(random.choices(pop, weights=probabilities)[0])
